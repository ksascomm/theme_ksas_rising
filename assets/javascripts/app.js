			...
			var $sidescroll	= (function() {
				...
				var $rows			= $('#container > div.ss-row'),
					...
					init			= function() {
						...
						$rowsViewport.find('a.trigger').addClass('ss-circle-deco');
					...
					initEvents		= function() {
						...
						$(window).on({
							...
							'resize.Scrolling' : function( event ) {
								...
								$rows.find('a.trigger').removeClass('ss-circle-deco');
					...
					placeRows		= function() {
						...
						$rowsOutViewport.each( function(i) {
							...
							var $row	= $(this),
								...
								$rowL	= $row.find('div.left'),
								// the right side element
								$rowR	= $row.find('div.right'),
								// top value
								rowT	= $row.offset().top;
							...
							// if not, the row should become visible (0% of left/right) as it gets closer to the center of the screen.
								...
								if( val <= 0 ) {
									...
									if( !$row.data('pointer') ) {
										...
										$row.find('.trigger').addClass('ss-circle-deco');
									...
									if( $row.data('pointer') ) {
										...
										$row.find('.trigger').removeClass('ss-circle-deco');
